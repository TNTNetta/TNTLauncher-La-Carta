        ...
        val.onclick = (e) => {
            ...
            if(Object.keys(ConfigManager.getAuthAccounts()).length === 1){
                ...
                setOverlayContent(
                    ...
                    'Para usar el Launcher, debe iniciar sesión en al menos una cuenta. Deberá volver a iniciar sesión después.<br><br>¿Está seguro de que desea cerrar la sesión?',
                    'Estoy seguro',
                    'Cancelar'
                )
                setOverlayHandler(() => {
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/TNTNetta/TNTLauncher-La-Carta/releases.atom',
        success: (data) => {
...
function populateSettingsUpdateInformation(data){
    if(data != null){
        settingsUpdateTitle.innerHTML = `Nueva ${isPrerelease(data.version) ? 'Pre-version' : 'Version'} disponible`
        ...
        settingsUpdateTitle.innerHTML = 'Está ejecutando la última versión'
        settingsUpdateChangelogCont.style.display = 'ninguna'
